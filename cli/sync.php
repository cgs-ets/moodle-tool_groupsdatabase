...
/**
 * CLI sync for groups database synchronisation.
 *
...
if ($options['help']) {
    $help = "Execute groups sync with external database.
...
Example:
\$ sudo -u www-data /usr/bin/php admin/tool/groupsdatabase/cli/sync.php
";
...
$result = $result | $groupsdatabase->sync($trace);
